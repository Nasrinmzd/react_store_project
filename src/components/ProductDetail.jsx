      ...
      <div className="p-6 lg:max-w-7xl max-w-2xl max-lg:mx-auto">
        <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-2xl font-extrabold mb-12 text-white">{product.title}</h2>
            <div className="flex flex-wrap gap-4 mt-4">
              <p className="text-indigo-500 text-4xl font-bold">${product.price}</p>
              <p className="text-gray-400 text-xl">{product.discountPercentage}%</p>
            </div>
            ...
            <div className="mt-10 flex flex-col">
              ...
              <span className="space-y-3 list-disc mt-3 text-sm text-white">{product.description}</span>
              <p className="mt-6 text-white capitalize">Category: <span className="text-gray-400">{product.category}</span></p>
              <p className="text-white">Brand: <span className="text-gray-400">{product.brand}</span></p>
            </div>
              <button
                type="button"
